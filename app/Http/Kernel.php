...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        // Custom middleware group for inventory API endpoints
        'inventory.api' => [
            \Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::class,
            \App\Http\Middleware\ValidateApiAuthentication::class,
            \App\Http\Middleware\ValidateInventoryData::class,
            \Illuminate\Routing\Middleware\ThrottleRequests::class . ':inventory-api',
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ];
